package cz.scholz.demojugberlinbrandenburg2019.streams;
...
public class Config {
    ...
    public Config(String bootstrapServers, String leftSourceTopic, String rightSourceTopic, String targetTopic, String trustStorePassword, String trustStorePath, String keyStorePassword, String keyStorePath, String username, String password) {
    ...
    public static Config fromEnv() {
        ...
        return new Config(bootstrapServers, leftSourceTopic, rightSourceTopic, targetTopic, trustStorePassword, trustStorePath, keyStorePassword, keyStorePath, username, password);
    }
    ...
    public String getEmailAndAddressTopic() {
        return targetTopic;
    }
    ...
    public static Properties getKafkaStreamsProperties(Config config) {
        Properties props = new Properties();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "transform-and-aggregate");
